...
export default function OtherPhysicalScreen() {
  ...
  const cards: Card[] = [
    ...
    },
    {
      ...
      route: "/challenges/otherphysical/physical-exam",
    },
    {
      label: "Team / Individual Sport",
      icon: "🏀",
      color: Colors.cards.journal,
      route: "/challenges/otherphysical/sport",
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerText}>
        <Text style={styles.title}>Other Physical</Text>

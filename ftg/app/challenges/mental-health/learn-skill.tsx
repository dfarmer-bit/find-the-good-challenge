...
export default function LearnSkillScreen() {
  ...
  const submit = async () => {
    ...
    const { error } = await supabase
      ...
      .insert({
        challenge_id: "62fba13d-c026-4846-b711-b985e3cfd117",
        status: "pending",
        media_url: photoUri,
        metadata: {
          title: title.trim(),
    ...
    if (error) {
      Alert.alert(
        "Already submitted",
        "You can submit this challenge once per month."
      );
      return;
    }
        ...
        >
          ...
          <View style={{ marginTop: 10 }}>
            ...
            <TextInput
              ...
              placeholder="Describe the skill and what you learned"
              placeholderTextColor={Colors.textSecondary}
              value={description}
          ...
          <View style={styles.photoSection}>
            <Text style={styles.photoLabel}>Proof (optional)</Text>

// app/challenges/mission/step-4.tsx
...
export default function MissionStep4() {
  ...
  const handleContinue = () => {
    if (!selected) return;
    setAnswer("step4_impact", selected);
    router.push("/challenges/mission/step-5" as Href);
  };
  ...
  return (
    <View style={styles.screen}>
      ...
      >
        <Text style={styles.progress}>Step 4 of 10</Text>

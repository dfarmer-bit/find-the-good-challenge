...
export default function SpiritualEventScreen() {
  ...
  const submit = async () => {
    ...
    // Get challenge ID dynamically
    const { data: challenge, error: challengeError } =
      await supabase
        .from("challenges")
        .select("id")
        .eq("name", "Spiritual Event Attendance")
        .single();
    ...
    Alert.alert(
      "Submitted",
      "Your spiritual event has been recorded.",
      ...
      >
        ...
        >
          ...
          <TextInput
            ...
            placeholder="Describe the event or service attended"
            placeholderTextColor={Colors.textSecondary}
            value={description}
